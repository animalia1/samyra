...
<div class="wrapper theme-1-active navbar-top-pink horizontal-nav">
    ...
    <div class="fixed-sidebar-left">
        <ul class="nav navbar-nav side-nav nicescroll-bar">
            ...
            <!--SAmyra-->
            <li>
                <a href="javascript:void(0);" data-toggle="collapse" data-target="#product_dr"><div class="pull-left"><i class=ti-image mr-20" ></i><span class="right-nav-text">Gestion Marketing</span></div><div class="pull-right"><i class="ti-angle-down"></i></div><div class="clearfix"></div></a>
                <ul id="product_dr" class="collapse collapse-level-1">
                    <li>
                        <a href="form-events.php">Ajout evenement</a>
                    </li>
                    <li>
                        <a href="afficherEvenement.php">Les Evènements</a>
                    </li>
                    <li>
                        <a href="form_promotion.php">Ajout promotion</a>
                    </li>
                    <li>
                        <a href="afficherPromotion.php">Les Promotions</a>
                    </li>
                </ul>
            </li>
