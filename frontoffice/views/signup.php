...
<head>
    ...
    <title>My Account | HTML Commerce Template</title>
                ...
                <div class="col-md-12">
                    <div class="main-content">
                        <div class="commerce commerce-account">
                            <h2 class="commerce-account-heading">suscribe</h2>
                            <form method="POST" action="ajouterclient.php" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password1" required="" id="exampleInputpwd_2" placeholder="Enter pwd">
                                </div>
                                <div class="form-group">
                                    <label class="pull-left control-label mb-10">Confirm Password</label>
                                    <input type="password" class="form-control" name="password2" required="" id="exampleInputpwd_3" placeholder="Enter pwd">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group text-center">
                                    <input class="btn  btn-primary btn-rounded" type="submit" id="" name="Sign up" value="Sign up" onclick="test()">
                                </div>
                            </form>
                        </div>
                    </div>
