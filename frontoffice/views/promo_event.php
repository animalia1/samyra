                ...
                <div class="product-slider-title">
                    ...
                    <!--afficghage de la listes des evenements que je dois remplaces par une image-->
                        ...
                        foreach($liste as $row){
                            ?>
            <tr>
                <li class="product product-no-border style-2 masonry-item col-md-3 col-sm-6 aliquam maecenas">
                    <div class="product-container">
                        <figure>
                            <div class="product-wrap">
                                <div class="product-images">
                                    <div class="shop-loop-thumbnail shop-loop-back-thumbnail">
                                        <a href="shop-detail-1.php"> <?PHP  echo '<img class="img-thumbnail img-fluid"  src="img/' . $row["image"] . '">';?></a>
                                ...
                                <div class="shop-loop-product-info">
                                    ...
                                    <div class="info-content-wrap">
                                        <h3 class="product_title">
                                            <a href="shop-detail-1.php"><?PHP echo $row['nom']; ?></a>
                                        </h3>
                                        <div class="info-price">
																		<span class="price">
																			<ins><span class="amount"><?PHP echo $row['date_deb']; ?></span></ins>
																			<ins><span class="amount"><?PHP echo $row['date_fin']; ?></span></ins>
																		</span>
                                        </div>
                                            ...
                                            <div class="loop-add-to-cart">
                                                <a href="#" class="add_to_cart_button">
                                                    <form method="POST"  action="participer.php">
                                                            <p><input  class="btn btn-primary btn-sm" type="submit" id="btn1" value="participer" onclick="disableButton(this)"</p>
